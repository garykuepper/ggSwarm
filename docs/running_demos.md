...
```powershell
$env:PYTHONPATH="c:\Users\gkuep\Code\isaaclab\ggSwarm\source\ggSwarm"; c:\Users\gkuep\Code\isaaclab\ggSwarm\env_isaaclab\Scripts\python.exe scripts\skrl\train.py --task=Template-GGSwarm-Marl-Direct-v0 --algorithm=MAPPO --headless --ml_framework torch --gnn
```
...
```powershell
c:\Users\gkuep\Code\isaaclab\ggSwarm\env_isaaclab\Scripts\tensorboard.exe --logdir=logs/skrl/ggswarm_marl
```
...
```powershell
$env:PYTHONPATH="c:\Users\gkuep\Code\isaaclab\ggSwarm\source\ggSwarm"; c:\Users\gkuep\Code\isaaclab\ggSwarm\env_isaaclab\Scripts\python.exe scripts\skrl\play.py --task=Template-GGSwarm-Marl-Direct-v0 --algorithm=MAPPO --ml_framework torch --gnn
```
