...
def main():
    ...
    # Camera settings (Adjust these to zoom in/out)
    # [X, Y, Z] offset from the drone
    ...
    while simulation_app.is_running():
        ...
        # Calculate thrust with device safety
        drone_wt = robot_mass * gravity
        # Use sim.device to avoid mismatch between CUDA and CPU
        sin_wave = torch.sin(torch.tensor(sim_time * 10.0, device=sim.device))
